...
public class AnvilGUI {
    ...
    private static final AnvilWrapper WRAPPER = new AnvilWrapper();
    ...
    public void setTitle(String literalTitle, boolean preserveRenameText) {
        Objects.requireNonNull(literalTitle, "literalTitle cannot be null");
    ...
    public static class Builder {
         ...
         */
        private Object titleComponent = Component.literal("Repair & Name");
        /**
        ...
        public Builder title(String title) {
            ...
            this.titleComponent = Component.literal(title);
            return this;
        }
