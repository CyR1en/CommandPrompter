 ...
 *
 * <p>The string value is parsed by the matching {@link
 * dev.cyr1en.promptcore.config.handlers.ConfigTypeHandler} for the field's type. Only effective
 * when the field also carries {@link ConfigNode}.
 */
