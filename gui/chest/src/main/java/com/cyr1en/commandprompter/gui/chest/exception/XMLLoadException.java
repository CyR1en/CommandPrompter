package com.cyr1en.commandprompter.gui.chest.exception;

import org.jetbrains.annotations.NotNull;

/**
 * An exception indicating that something went wrong while trying to load a {@link com.cyr1en.commandprompter.gui.chest.type.util.Gui} from an XML file.
 *
 * @since 0.3.0
 */
