...
/**
 * Represents a parsed Minecraft version string (e.g., "1.21.4"). Implements {@link Comparable} for
 * version ordering.
 */
public final class Version implements Comparable<Version> {

  private static final Pattern VERSION_PATTERN =
      Pattern.compile("^(\\d+)(?:\\.(\\d+))?(?:\\.(\\d+))?(?:-pre(\\d+))?$");
  ...
  public static Version of(@NotNull String version) {
    ...
    int preRelease =
        matcher.group(4) != null ? Integer.parseInt(matcher.group(4)) : Integer.MAX_VALUE;
  ...
  /**
   * Formats the version as a dot-separated string (e.g. "1.21.4" or "1.21.4-pre1"). Omits patch
   * when zero, and omits pre-release suffix for release versions.
   */
  @Override
