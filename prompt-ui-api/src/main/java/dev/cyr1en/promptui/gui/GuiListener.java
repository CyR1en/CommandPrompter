 ...
 *
 * <p>A single instance is created per plugin and registered as a Bukkit {@link Listener}. All
 * {@link Gui} instances are tracked and their callbacks are invoked through this listener.
 */
public final class GuiListener implements Listener {
  ...
  /**
   * Routes click events to the appropriate GUI callbacks (global, top/bottom, outside) and
   * dispatches to the component for pane-level handling.
   */
  @EventHandler(priority = EventPriority.LOWEST)
  ...
  /**
   * Routes drag events to the appropriate GUI callbacks and cancels drags that touch the top
   * inventory.
   */
  @EventHandler(priority = EventPriority.LOWEST)
  ...
  /**
   * Intercepts item pickups for players with an open GUI, adding the item to the cache instead of
