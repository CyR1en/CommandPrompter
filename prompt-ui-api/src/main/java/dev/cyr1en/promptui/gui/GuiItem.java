 ...
 *
 * <p>UUIDs are embedded in the item's {@link org.bukkit.persistence.PersistentDataContainer} via
 * {@link UUIDTagType} so the framework can match clicked items even when they have been moved
 * between slots.
 */
public final class GuiItem {

  private static final NamespacedKey UUID_KEY =
      new NamespacedKey("commandprompter", "gui-item-uuid");
