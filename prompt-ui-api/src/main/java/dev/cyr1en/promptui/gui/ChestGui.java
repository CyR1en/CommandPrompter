 ...
 *
 * <p>The component covers the chest rows only. Player-inventory rows are not advertised until they
 * have a real renderer; bottom-inventory interaction is disabled by default rather than silently
 * exposing an unrendered component.
 */
