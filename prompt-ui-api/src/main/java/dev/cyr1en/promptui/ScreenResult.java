 ...
 *
 * <p>For successful input, use {@link #answer(String)}; for cancellation, use {@link
 * #cancel(CancelReason)} or {@link #cancel()}. Consumers can check {@link #cancelled()} or inspect
 * {@link #outcome()} and {@link #cancelReason()}.
 */
public record ScreenResult(String answer, Outcome outcome, CancelReason cancelReason) {
  ...
  public static ScreenResult cancel(CancelReason reason) {
    return new ScreenResult("", Outcome.CANCELLED, reason != null ? reason : CancelReason.GUI_EXIT);
  }
