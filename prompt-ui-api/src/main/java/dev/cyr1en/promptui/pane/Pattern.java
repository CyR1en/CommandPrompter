 ...
 *
 * <p>A pattern is a series of lines where '1' means enabled and '0' means disabled. The pattern can
 * repeat naturally or be wrapped to fit a target container size.
 *
 * <h3>Example</h3>
 *
 * <pre>{@code
...
public final class Pattern {
  ...
  /**
   * Creates a pattern from one or more glyph lines. Each line should contain {@code '1'} (enabled)
   * and {@code '0'} (disabled) characters.
   */
