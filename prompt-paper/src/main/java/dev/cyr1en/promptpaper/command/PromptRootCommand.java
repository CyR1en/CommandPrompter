...
public class PromptRootCommand extends PromptCommand implements Command<CommandSourceStack> {
  ...
  public LiteralCommandNode<CommandSourceStack> build() {
    var literal = Commands.literal(name()).requires(src -> allowed(src.getSender())).executes(this);
  ...
  /**
   * Sends the help text. Extracted from the Brigadier executor for direct unit testing with a mock
   * {@link CommandSender}.
   */
