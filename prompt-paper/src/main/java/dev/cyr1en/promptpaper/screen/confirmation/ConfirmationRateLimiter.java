...
public final class ConfirmationRateLimiter {
  ...
  /**
   * Checks whether a log warning on the default {@link LogChannel#RATE_LIMIT} channel should be
   * emitted for the player. Guarantees at most one log emission per player per rate-limit window
   * for this channel.
   *
   * @param playerUuid player UUID
