...
/**
 * Dedicated {@link InventoryHolder} for {@link ItemPromptScreen} inventories. Carries the
 * screen mode so event handlers can identify and route interactions without touching
 * shared or cached holders.
 */
