...
/**
 * Tracks the open/result lifecycle of a native dialog without depending on
 * Paper's versioned dialog API.
 */
public final class DialogLifecycle {
    ...
    /**
     * Closes the client dialog before delivering its result. The ordering is
     * important because the result callback may immediately open the next
     * dialog in the prompt session.
     *
