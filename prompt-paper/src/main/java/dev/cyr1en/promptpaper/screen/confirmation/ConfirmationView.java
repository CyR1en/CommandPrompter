 ...
 *
 * <p>Implementations manage concrete presentation mechanics (e.g. Chest GUI,
 * Native Dialog, Chat) and deliver a single {@link ConfirmationOutcome} to the
 * coordinator.
 */
public interface ConfirmationView {
    ...
    /**
     * Registers a failure callback invoked if asynchronous or synchronous opening fails,
     * allowing the coordinator to trigger fallback to another view.
     *
