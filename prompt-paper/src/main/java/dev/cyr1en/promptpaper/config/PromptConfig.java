...
import dev.cyr1en.promptpaper.config.sub.AnvilGuiConfig;
import dev.cyr1en.promptpaper.config.sub.ConfirmationScreenConfig;
import dev.cyr1en.promptpaper.config.sub.ControlItem;
import dev.cyr1en.promptpaper.config.sub.DialogConfig;
import dev.cyr1en.promptpaper.config.sub.PlayerUiConfig;
import dev.cyr1en.promptpaper.config.sub.SearchAnvilItem;
import dev.cyr1en.promptpaper.config.sub.SignUiConfig;
import dev.cyr1en.promptpaper.config.sub.TextPromptConfig;
import dev.cyr1en.promptpaper.validation.CompoundedValidator;
import dev.cyr1en.promptpaper.validation.InputValidator;
import dev.cyr1en.promptpaper.validation.JSExprValidator;
import dev.cyr1en.promptpaper.validation.NoopValidator;
import dev.cyr1en.promptpaper.validation.OnlinePlayerValidator;
import dev.cyr1en.promptpaper.validation.RegexValidator;
 ...
 *
 * <p>This record holds every configurable aspect of the prompt system: Player UI layout, Anvil GUI
 * items, text-prompt cancel behaviour, sign UI material, dialog UI defaults, and input-validation
 * aliases. Grouped sub-records ({@link PlayerUiConfig}, {@link AnvilGuiConfig}, etc.) are produced
 * by accessor methods for ergonomic consumption.
 *
...
@SectionComments({
  @SectionComment(
      path = "PlayerUI",
      comments = {"PlayerUI formatting"}),
  @SectionComment(
      path = "AnvilGUI",
      comments = {"AnvilUI formatting"}),
  @SectionComment(
      path = "AnvilGUI.Item",
      comments = {"The Left item to place on the Anvil GUI"}),
  @SectionComment(
      path = "AnvilGUI.ResultItem",
      comments = {"The Result item to place on the Anvil GUI"}),
  @SectionComment(
      path = "AnvilGUI.CancelItem",
      comments = {"The Cancel item to place on the Anvil GUI"}),
  @SectionComment(
      path = "TextPrompt",
      comments = {"Text Prompt Config"}),
  @SectionComment(
      path = "SignUI",
      comments = {"Sign UI Settings"}),
  @SectionComment(
  ...
  @SectionComment(
      path = "DialogUI.Confirm-Button",
      comments = {"submit / dismiss button label+tooltip."}),
  @SectionComment(
      path = "DialogUI.Cancel-Button",
      comments = {"submit / dismiss button label+tooltip."}),
  @SectionComment(
      path = "ConfirmationUI",
      comments = {"Confirmation UI Settings"})
})
public record PromptConfig(
    ...
    @ConfigNode @NodeName("PlayerUI.Skull-Custom-Model-Data") @NodeDefault("0")
    ...
    @ConfigNode
        ...
        int cacheDelay,
    @ConfigNode @NodeName("PlayerUI.Previous.Item") @NodeDefault("Feather") String previousItem,
    @ConfigNode @NodeName("PlayerUI.Previous.Custom-Model-Data") @NodeDefault("0")
        int previousCustomModelData,
    @ConfigNode @NodeName("PlayerUI.Previous.Column") @NodeDefault("3") int previousColumn,
    @ConfigNode @NodeName("PlayerUI.Previous.Text") @NodeDefault("&7◀◀ Previous")
        String previousText,
    @ConfigNode @NodeName("PlayerUI.Next.Item") @NodeDefault("Feather") String nextItem,
    @ConfigNode @NodeName("PlayerUI.Next.Custom-Model-Data") @NodeDefault("0")
        int nextCustomModelData,
    @ConfigNode @NodeName("PlayerUI.Next.Column") @NodeDefault("7") int nextColumn,
    @ConfigNode @NodeName("PlayerUI.Next.Text") @NodeDefault("Next ▶▶") String nextText,
    @ConfigNode @NodeName("PlayerUI.Cancel.Item") @NodeDefault("Barrier") String cancelItem,
    @ConfigNode @NodeName("PlayerUI.Cancel.Custom-Model-Data") @NodeDefault("0")
        int cancelCustomModelData,
    @ConfigNode @NodeName("PlayerUI.Cancel.Column") @NodeDefault("5") int cancelColumn,
    @ConfigNode @NodeName("PlayerUI.Cancel.Text") @NodeDefault("&7Cancel ✘") String cancelText,
    @ConfigNode @NodeName("PlayerUI.Search.Item") @NodeDefault("Name_Tag") String searchItem,
    @ConfigNode @NodeName("PlayerUI.Search.Custom-Model-Data") @NodeDefault("0")
        int searchCustomModelData,
    @ConfigNode @NodeName("PlayerUI.Search.Column") @NodeDefault("9") int searchColumn,
    @ConfigNode @NodeName("PlayerUI.Search.Text") @NodeDefault("&6Search ⌕") String searchText,
    @ConfigNode @NodeName("PlayerUI.Search.AnvilItem.Title") @NodeDefault("&6&lPlayer Search")
        String searchAnvilItemTitle,
    @ConfigNode @NodeName("PlayerUI.Search.AnvilItem.Material") @NodeDefault("PAPER")
        String searchAnvilItem,
    @ConfigNode @NodeName("PlayerUI.Search.AnvilItem.CustomModelData") @NodeDefault("0")
        int searchAnvilItemCustomModelData,
    @ConfigNode @NodeName("PlayerUI.Search.AnvilItem.Text") @NodeDefault("&6Enter Player Name")
    ...
    @ConfigNode
        ...
        String emptyMessage,
    @ConfigNode @NodeName("PlayerUI.Filter-Format.World") @NodeDefault("&6\uD804\uDC4D %s")
        String worldFilterFormat,
    @ConfigNode @NodeName("PlayerUI.Filter-Format.Radial") @NodeDefault("&cᯤ %s")
    ...
    @ConfigNode @NodeName("AnvilGUI.Item.Custom-Model-Data") @NodeDefault("0")
    ...
    @ConfigNode @NodeName("AnvilGUI.ResultItem.Material") @NodeDefault("Paper")
    ...
    @ConfigNode @NodeName("AnvilGUI.ResultItem.Custom-Model-Data") @NodeDefault("0")
    ...
    @ConfigNode @NodeName("AnvilGUI.CancelItem.Custom-Model-Data") @NodeDefault("0")
    ...
    @ConfigNode @NodeName("AnvilGUI.CancelItem.HoverText") @NodeDefault("&cClick to Cancel")
    ...
    @ConfigNode @NodeName("SignUI.Material") @NodeDefault("OAK_SIGN") @Match(regex = "(.*SIGN.*)")
        String signMaterial,
    ...
    @ConfigNode
        ...
        String dialogTitle,
    @ConfigNode @NodeName("DialogUI.Confirm-Button.Label") @NodeDefault("<green>Confirm</green>")
        String dialogConfirmLabel,
    @ConfigNode @NodeName("DialogUI.Confirm-Button.Tooltip") @NodeDefault("Confirm this action")
        String dialogConfirmTooltip,
    @ConfigNode @NodeName("DialogUI.Cancel-Button.Label") @NodeDefault("<red>Cancel</red>")
        String dialogCancelLabel,
    @ConfigNode @NodeName("DialogUI.Cancel-Button.Tooltip") @NodeDefault("Cancel this action")
    ...
    @ConfigNode
        ...
        @NodeDefault("")
        @NodeComment({
          "Default options for the <d:choice[...]:...> form when no",
    ...
    @ConfigNode
        ...
        @NodeDefault("0")
        @NodeComment({
          "defaults for the <d:num...> variant.",
          "Initial is optional; if omitted, uses (min + max) / 2."
        })
        float dialogNumberMin,
    @ConfigNode @NodeName("DialogUI.Defaults.Number.Max") @NodeDefault("100") float dialogNumberMax,
    @ConfigNode @NodeName("DialogUI.Defaults.Number.Step") @NodeDefault("1") float dialogNumberStep,
    @ConfigNode
        @NodeName("DialogUI.Defaults.Tab.MaxButtons")
        @NodeDefault("5")
        @IntegerConstraint(min = 1, max = 256)
        @NodeComment({
          "threshold for the <d:tab:Display> form. When the",
    ...
    @ConfigNode @NodeName("ConfirmationUI.GUI.Confirm-Item.Material") @NodeDefault("LIME_CONCRETE")
        String confirmationConfirmItemMaterial,
    @ConfigNode @NodeName("ConfirmationUI.GUI.Confirm-Item.Name") @NodeDefault("&aConfirm")
    ...
    @ConfigNode @NodeName("ConfirmationUI.GUI.Cancel-Item.Material") @NodeDefault("RED_CONCRETE")
        String confirmationCancelItemMaterial,
    @ConfigNode @NodeName("ConfirmationUI.GUI.Cancel-Item.Name") @NodeDefault("&cCancel")
    ...
    @ConfigNode @NodeName("ConfirmationUI.GUI.Info-Item.Material") @NodeDefault("PAPER")
        String confirmationInfoItemMaterial,
    @ConfigNode @NodeName("ConfirmationUI.GUI.Info-Item.Name") @NodeDefault("&eInformation")
    ...
    @ConfigNode @NodeName("ConfirmationUI.Default-Confirm-Label") @NodeDefault("&aConfirm")
        String confirmationDefaultConfirmLabel,
    @ConfigNode @NodeName("ConfirmationUI.Default-Cancel-Label") @NodeDefault("&cCancel")
        String confirmationDefaultCancelLabel,
    @ConfigNode @NodeName("ConfirmationUI.Sound") @NodeDefault("") String confirmationSound)
  ...
  public PromptConfig {
    ...
    if (confirmationConfirmItemSlot < 0
        || confirmationConfirmItemSlot > 26
        || confirmationCancelItemSlot < 0
        || confirmationCancelItemSlot > 26
        || confirmationInfoItemSlot < 0
        || confirmationInfoItemSlot > 26) {
      throw new IllegalArgumentException(
  ...
  private static void validateRegex(String path, String regex) {
    if (regex == null) {
      throw new IllegalArgumentException(
          "Configured validator regex '" + path + "' must not be null");
    }
    try {
  ...
  public PlayerUiConfig playerUi() {
    return new PlayerUiConfig(
        ...
        new SearchAnvilItem(
            searchAnvilItemTitle,
            searchAnvilItem,
            searchAnvilItemCustomModelData,
            searchAnvilItemText),
        sorted,
        emptyMessage,
        worldFilterFormat,
  ...
  public TextPromptConfig textPrompt() {
    return new TextPromptConfig(
        sendCancelText, textCancelMessage, textCancelHoverMessage, responseListenerPriority);
  }

  /** Builds grouped dialog configuration from {@code DialogUI}. */
  ...
  public ConfirmationScreenConfig confirmationConfig() {
    ...
    return new ConfirmationScreenConfig(
        ...
        new ConfirmationScreenConfig.ConfirmationItem(
            ...
            confirmationConfirmItemSlot),
        new ConfirmationScreenConfig.ConfirmationItem(
            confirmationCancelItemMaterial, confirmationCancelItemName, confirmationCancelItemSlot),
        new ConfirmationScreenConfig.ConfirmationItem(
            confirmationInfoItemMaterial, confirmationInfoItemName, confirmationInfoItemSlot),
  ...
  public String getFilterFormat(String key) {
    ...
    String val = rawConfig.getString("PlayerUI.Filter-Format." + key);
  ...
  /**
   * Resolves an {@link InputValidator} for the given alias, combining regex, JS-expression, and
   * online-player checks as configured in {@code Input-Validation} YAML entries.
   *
   * @param alias the validator alias (e.g. {@code "is"}, {@code "ss"})
  ...
  public InputValidator getInputValidator(String alias, Player player, CommandPrompter plugin) {
    if (alias == null || alias.isBlank()) return new NoopValidator();
  ...
  private InputValidator[] findValidators(String alias, Player player, CommandPrompter plugin) {
    ...
    var isPlayer = Boolean.parseBoolean(getIVValue("Alias", alias, "Online-Player"));
    if (isPlayer) list.add(new OnlinePlayerValidator(alias, getIVErrMessage(alias), player));

    return list.toArray(new InputValidator[0]);
  }

  /**
   * Shorthand for {@link #getInputValidationValue} targeting the {@code "Input-Validation"}
   * section.
   */
