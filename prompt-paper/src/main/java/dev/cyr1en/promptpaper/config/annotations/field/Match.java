 ...
 *
 * <p>If the YAML value does not fully match {@link #regex()}, an
 * {@link IllegalArgumentException} is thrown during {@link dev.cyr1en.promptpaper.config.ConfigurationManager#getConfig}.
 */
