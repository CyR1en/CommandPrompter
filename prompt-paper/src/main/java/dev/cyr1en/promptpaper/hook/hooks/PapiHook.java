...
/**
 * Hook for the PlaceholderAPI plugin. Resolves PlaceholderAPI placeholders in strings scoped to a
 * specific player.
 */
...
public class PapiHook extends BaseHook {
  ...
  /**
   * Resolves PlaceholderAPI placeholders in the text for the given player. Returns the text
   * unchanged if no placeholders are present.
   */
