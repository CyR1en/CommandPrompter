...
/**
 * Extension point for hooks that register player-list filters with {@link HeadCache} (e.g. Towny,
 * LuckPerms, WorldGuard). Each filter is identified by a regex key used in prompt player-selectors.
 */
