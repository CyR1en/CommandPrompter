...
/**
 * Extension point for chat-input hooks that replace the default Bukkit {@code AsyncChatEvent}
 * listener (e.g. CarbonChat). When multiple hooks implement this interface, the first one whose
 * {@link #subscribe} returns {@code true} wins.
 */
