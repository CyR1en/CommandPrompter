...
/**
 * Abstract base for plugin hooks that need access to the {@link CommandPrompter} instance. All
 * concrete hooks should extend this class (or implement {@link PluginHook} directly if they don't
 * need the plugin reference).
 */
