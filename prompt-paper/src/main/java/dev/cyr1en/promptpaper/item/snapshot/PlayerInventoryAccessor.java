...
/**
 * Accessor for player inventory slots that routes slots to their explicit Bukkit methods (such as
 * armor and offhand) and enforces defensive copying on all reads and writes.
 */
