...
/**
 * Pure utility class defining slot mappings between GUI container slots and logical player inventory slots.
 * <p>
 * Mapping specifications:
 * <ul>
 *   <li>GUI {@code 0..26} &rarr; Player logical {@code 9..35} (main inventory rows 1-3)</li>
 *   <li>GUI {@code 27..35} &rarr; Player logical {@code 0..8} (hotbar)</li>
 *   <li>GUI {@code 45} &rarr; Player logical {@code 40} (offhand)</li>
 *   <li>GUI {@code 46} &rarr; Player logical {@code 36} (boots)</li>
 *   <li>GUI {@code 47} &rarr; Player logical {@code 37} (leggings)</li>
 *   <li>GUI {@code 48} &rarr; Player logical {@code 38} (chestplate)</li>
 *   <li>GUI {@code 49} &rarr; Player logical {@code 39} (helmet)</li>
 * </ul>
 */
public final class ItemSlotMapping {
    ...
    static {
        ...
        Map<Integer, Integer> p2g = new LinkedHashMap<>(TOTAL_PLAYER_SLOTS);
    ...
    public static Optional<SlotCategory> getCategoryForGuiSlot(int guiSlot) {
        ...
        return playerSlot.isPresent() ? getCategoryForPlayerSlot(playerSlot.getAsInt()) : Optional.empty();
    }
