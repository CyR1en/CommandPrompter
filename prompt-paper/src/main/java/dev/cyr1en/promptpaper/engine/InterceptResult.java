...
public sealed interface InterceptResult {
  ...
  /**
   * The command was rejected under the fail-closed policy (e.g. unknown screen key, missing preset
   * ID, missing validator alias, structural syntax error, or reload in progress).
   *
