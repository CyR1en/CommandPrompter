...
/**
 * Public service implementation of {@link CommandPrompterAPI} registered in Bukkit's
 * ServicesManager.
 *
 * <p>Delegates registration to {@link CustomScreenRegistry} and unregistration to {@link
 * ProviderLifecycleCoordinator}, ensuring that explicit unregistration executes the exact same
 * lifecycle cleanup, session cancellation, platform close, and audit logging as provider disable
 * events.
 */
public final class CommandPrompterAPIFacade implements CommandPrompterAPI {
  ...
  public CommandPrompterAPIFacade(
      CustomScreenRegistry registry, ProviderLifecycleCoordinator coordinator) {
