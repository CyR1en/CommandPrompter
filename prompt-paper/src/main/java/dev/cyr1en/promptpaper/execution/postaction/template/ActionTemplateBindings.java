...
public final class ActionTemplateBindings implements TemplateBindings {
    ...
    private ActionTemplateBindings(List<String> answers, String playerName, PapiReferenceResolver papiResolver) {
        this.answers = answers == null ? List.of() : List.copyOf(answers);
        this.playerName = playerName;
        this.papiResolver = papiResolver;
    }

    public static ActionTemplateBindings of(List<String> answers, String playerName, PapiReferenceResolver papiResolver) {
