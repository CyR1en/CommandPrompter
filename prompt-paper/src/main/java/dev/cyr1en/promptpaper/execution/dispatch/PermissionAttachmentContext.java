...
public record PermissionAttachmentContext(String permissionKey, List<String> permissionSnapshot) {
  public PermissionAttachmentContext {
    permissionSnapshot = permissionSnapshot == null ? List.of() : List.copyOf(permissionSnapshot);
  }

  public static PermissionAttachmentContext of(
      String permissionKey, List<String> permissionSnapshot) {
