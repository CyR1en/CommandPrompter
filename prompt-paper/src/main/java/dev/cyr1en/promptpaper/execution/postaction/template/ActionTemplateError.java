...
public record ActionTemplateError(ActionTemplateErrorCode code, String message, Throwable cause) {
  ...
  public static ActionTemplateError of(
      ActionTemplateErrorCode code, String message, Throwable cause) {
