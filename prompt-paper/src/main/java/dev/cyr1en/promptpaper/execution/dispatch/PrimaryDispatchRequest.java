...
public record PrimaryDispatchRequest(
    ...
    public static PrimaryDispatchRequest player(Player player, String command, PlayerExecutor initiatorExecutor) {
        return new PrimaryDispatchRequest(player, command, DispatchMode.PLAYER, null, initiatorExecutor, null);
    }
    ...
    public static PrimaryDispatchRequest console(Player player, String command, PlayerExecutor initiatorExecutor) {
        return new PrimaryDispatchRequest(player, command, DispatchMode.CONSOLE, null, initiatorExecutor, null);
    }
    ...
    public static PrimaryDispatchRequest attachment(
        ...
        return new PrimaryDispatchRequest(player, command, DispatchMode.ATTACHMENT, attachmentContext, null, null);
    }
    ...
    public static PrimaryDispatchRequest attachment(
        ...
        return new PrimaryDispatchRequest(player, command, DispatchMode.ATTACHMENT, attachmentContext, initiatorExecutor, null);
    }
}
