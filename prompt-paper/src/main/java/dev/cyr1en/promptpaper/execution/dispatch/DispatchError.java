...
/**
 * Immutable failure descriptor for command dispatch operations. Detail messages are bounded and
 * C0-safe, and do not include full command strings.
 */
public record DispatchError(DispatchErrorKind kind, String detail, Throwable cause) {
    ...
    String msg =
        cause != null
            ? cause.getClass().getSimpleName()
                + ": "
                + (cause.getMessage() != null ? cause.getMessage() : "no detail")
            : "unknown exception";
