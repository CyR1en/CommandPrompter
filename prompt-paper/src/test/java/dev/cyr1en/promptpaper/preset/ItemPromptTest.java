...
class ItemPromptTest {
  ...
  class ModelTests {
    ...
    void catalogDefaultsCategoryToAll() {
      var prompt = new ItemPrompt("item", "i1", "Select item", ItemSource.CATALOG, ItemOutputFormat.MATERIAL, null, null, false);
    ...
    void catalogWithCustomCategory() {
      var prompt = new ItemPrompt("item", "i1", "Select item", ItemSource.CATALOG, ItemOutputFormat.KEY, "weapons", "sound.click", true);
    ...
    void itemPromptSoundValidation() {
      // Valid sounds
      assertDoesNotThrow(() -> new ItemPrompt("item", "i1", "Select item", null, null, null, "minecraft:ui.button.click", true));
      assertDoesNotThrow(() -> new ItemPrompt("item", "i1", "Select item", null, null, null, "entity.player.levelup", true));
      assertDoesNotThrow(() -> new ItemPrompt("item", "i1", "Select item", null, null, null, "custom.click_1", true));

      // Uppercase rejected
      assertThrows(IllegalArgumentException.class,
          () -> new ItemPrompt("item", "i1", "Select item", null, null, null, "MINECRAFT:CLICK", true));
      assertThrows(IllegalArgumentException.class,
    ...
    void itemPromptCategoryValidation() {
      // Valid categories
      assertDoesNotThrow(() -> new ItemPrompt("item", "i1", "Select item", ItemSource.CATALOG, null, "weapons", null, true));
      assertDoesNotThrow(() -> new ItemPrompt("item", "i1", "Select item", ItemSource.CATALOG, null, "rare_ores.tier-1", null, true));

      // Uppercase rejected
      assertThrows(IllegalArgumentException.class,
          () -> new ItemPrompt("item", "i1", "Select item", ItemSource.CATALOG, null, "WEAPONS", null, true));

      // Spaces rejected
      assertThrows(IllegalArgumentException.class,
          () -> new ItemPrompt("item", "i1", "Select item", ItemSource.CATALOG, null, "rare minerals", null, true));

      // Control characters rejected
      assertThrows(IllegalArgumentException.class,
          () -> new ItemPrompt("item", "i1", "Select item", ItemSource.CATALOG, null, "ores\u0000", null, true));
      assertThrows(IllegalArgumentException.class,
          () -> new ItemPrompt("item", "i1", "Select item", ItemSource.CATALOG, null, "ores\n", null, true));

      // Overlength rejected (> 64 chars)
      assertThrows(IllegalArgumentException.class,
          () -> new ItemPrompt("item", "i1", "Select item", ItemSource.CATALOG, null, "c".repeat(65), null, true));
    ...
    void nonCatalogWithCategoryThrows() {
      assertThrows(
          ...
          () -> new ItemPrompt("item", "i1", "Select item", ItemSource.INVENTORY, ItemOutputFormat.KEY, "weapons", null, true));
      assertThrows(
          IllegalArgumentException.class,
          () -> new ItemPrompt("item", "i1", "Select item", ItemSource.HAND, ItemOutputFormat.KEY, "weapons", null, true));
      assertThrows(
          IllegalArgumentException.class,
          () -> new ItemPrompt("item", "i1", "Select item", ItemSource.ARMOR, ItemOutputFormat.KEY, "weapons", null, true));
    }
    ...
    void catalogWithSlotOutputThrows() {
      assertThrows(
          IllegalArgumentException.class,
          () -> new ItemPrompt("item", "i1", "Select item", ItemSource.CATALOG, ItemOutputFormat.SLOT, null, null, true));
    }
    ...
    void nullRequiredFieldsThrow() {
      assertThrows(NullPointerException.class, () -> new ItemPrompt(null, "i1", "Text", null, null, null, null, true));
      assertThrows(NullPointerException.class, () -> new ItemPrompt("item", null, "Text", null, null, null, null, true));
      assertThrows(NullPointerException.class, () -> new ItemPrompt("item", "i1", null, null, null, null, null, true));
    }
    ...
    void timeoutValidation() {
      ...
      assertThrows(IllegalArgumentException.class, () -> new ItemPrompt("item", "i1", "Text", null, null, null, null, true, null, 0));
      assertThrows(IllegalArgumentException.class, () -> new ItemPrompt("item", "i1", "Text", null, null, null, null, true, null, 3601));
    }
  }
  ...
  class InlineTagMapperTests {
    ...
    void caseInsensitiveItemKeys() {
      assertInstanceOf(ItemPrompt.class, InlineTagMapper.toPromptDefinition(new PromptTag("<I:val>", "I", null, "val")));
      assertInstanceOf(ItemPrompt.class, InlineTagMapper.toPromptDefinition(new PromptTag("<ITEM:val>", "ITEM", null, "val")));
    }

    @Test
    void itemTagWithSourceAndOutputFlags() {
      var tag = new PromptTag("<i:Pick -source:hand -out:material>", "i", null, "Pick -source:hand -out:material");
    ...
    void itemTagCatalogWithCategoryAndSound() {
      var tag = new PromptTag("<i:Pick weapon -source:catalog -cat:swords -sound:minecraft:ui.button.click>", "i", null,
    ...
    void itemTagIncompatibleFlagsThrow() {
      var invalidTag = new PromptTag("<i:Choose -source:inv -cat:swords>", "i", null, "Choose -source:inv -cat:swords");
      assertThrows(IllegalArgumentException.class, () -> InlineTagMapper.toPromptDefinition(invalidTag));

      var invalidSlotTag = new PromptTag("<i:Choose -source:catalog -out:slot>", "i", null, "Choose -source:catalog -out:slot");
      assertThrows(IllegalArgumentException.class, () -> InlineTagMapper.toPromptDefinition(invalidSlotTag));
    }
  }
}
