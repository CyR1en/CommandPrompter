...
class PostActionResolverTest {
  ...
  private InputCompletion createCompletion(List<String> answers, PresetSnapshot snapshot) {
    return new InputCompletion(
        initiator, 1L, 0L, answers, "primary", null, snapshot, DispatchContextSnapshot.player());
  }
  ...
  class LegacyInlineTests {
    ...
    void resolvesMatchingOnComplete() {
      var pcm =
          new PostCommandMeta("say {0}", new int[] {0}, 10, false, DispatchTarget.CONSOLE, false);
      var completion = createCompletion(List.of("hello"), PresetSnapshot.empty());

      var resolved =
          PostActionResolver.resolve(
              pcm, ExecutionPolicy.ON_COMPLETE, completion, PapiReferenceResolver.empty());
    ...
    void resolvesMatchingOnCancel() {
      var pcm =
          new PostCommandMeta(
              "say cancelled {0}", new int[] {0}, 0, true, DispatchTarget.PLAYER, false);
      var completion = createCompletion(List.of("reason"), PresetSnapshot.empty());

      var resolved =
          PostActionResolver.resolve(
              pcm, ExecutionPolicy.ON_CANCEL, completion, PapiReferenceResolver.empty());
      assertNotNull(resolved);
      assertFalse(resolved.isNoOp());
    ...
    void skipsMismatchedPolicy() {
      var onCancelPcm =
          new PostCommandMeta("say cancel", new int[] {}, 0, true, DispatchTarget.PLAYER, false);
      var onCompletePcm =
          new PostCommandMeta("say complete", new int[] {}, 0, false, DispatchTarget.PLAYER, false);
      var completion = createCompletion(List.of(), PresetSnapshot.empty());

      assertNull(
          PostActionResolver.resolve(
              onCancelPcm, ExecutionPolicy.ON_COMPLETE, completion, PapiReferenceResolver.empty()));
      assertNull(
          PostActionResolver.resolve(
              onCompletePcm, ExecutionPolicy.ON_CANCEL, completion, PapiReferenceResolver.empty()));
    }
    ...
    void inlineDoesNotParsePapi() {
      var pcm =
          new PostCommandMeta(
              "give {player} %vault_eco_balance%",
              new int[] {}, 0, false, DispatchTarget.PLAYER, false);
      var completion = createCompletion(List.of(), PresetSnapshot.empty());
  ...
  class PresetPostCommandTests {
    ...
    void resolvesLegacyPresetAuthoritativePolicy() {
      var postCmd =
          new PostCommand(
              "reward_cmd",
              "give {player} diamond {input:1}",
              ExecutionPolicy.ON_COMPLETE,
              ExecuteAs.CONSOLE,
              15);
      var snapshot =
          new PresetSnapshot(Map.of(), Map.of("reward_cmd", postCmd), Map.of(), Map.of(), 1L);
      var completion = createCompletion(List.of("64"), snapshot);

      // Parser hint has onCancel = true, but preset has ON_COMPLETE -> preset wins!
      var pcm =
          new PostCommandMeta("reward_cmd", new int[] {}, 0, true, DispatchTarget.PLAYER, true);
      ...
      assertTrue(
          resolved.provenance().consoleDelegated(),
          "CONSOLE executeAs in trusted preset must set consoleDelegated = true");
    ...
    void resolvesLegacyPresetPlayerExecuteAs() {
      var postCmd =
          new PostCommand(
              ...
              0);
      var snapshot =
          new PresetSnapshot(Map.of(), Map.of("player_cmd", postCmd), Map.of(), Map.of(), 1L);
      var completion = createCompletion(List.of(), snapshot);
      var pcm =
          new PostCommandMeta("player_cmd", new int[] {}, 0, false, DispatchTarget.PLAYER, true);
    ...
    void unknownPresetIdFailsClosed() {
      ...
      var pcm =
          new PostCommandMeta(
              "non_existent_preset", new int[] {}, 0, false, DispatchTarget.PLAYER, true);
  ...
  class ConditionalPostCommandTests {
    ...
    void selectsIfTrueBranch() {
      var cond =
          ConditionCompiler.compile("{0} equals \"yes\"", ConditionCompileOptions.forPreset());
      ...
      var def =
          new ConditionalPostCommandDefinition(
              "cond1", cond, ExecutionPolicy.ON_COMPLETE, trueAction, falseAction);
    ...
    void absentBranchReturnsNoOp() {
      ...
      var def =
          new ConditionalPostCommandDefinition(
              "cond_noop", cond, ExecutionPolicy.ON_COMPLETE, trueAction, null);

      var snapshot = new PresetSnapshot(Map.of(), Map.of(), Map.of(), Map.of("cond_noop", def), 1L);
      var completion = createCompletion(List.of("no"), snapshot);
      var pcm =
          new PostCommandMeta("cond_noop", new int[] {}, 0, false, DispatchTarget.PLAYER, true);
    ...
    void numericConditionEvaluation() {
      ...
      var def =
          new ConditionalPostCommandDefinition(
              "cond_num", cond, ExecutionPolicy.ON_COMPLETE, trueAction, falseAction);

      var snapshot = new PresetSnapshot(Map.of(), Map.of(), Map.of(), Map.of("cond_num", def), 1L);
      var pcm =
          new PostCommandMeta("cond_num", new int[] {}, 0, false, DispatchTarget.PLAYER, true);

      // 150 >= 100 -> true
      var comp1 = createCompletion(List.of("150"), snapshot);
      var res1 =
          PostActionResolver.resolve(
              pcm, ExecutionPolicy.ON_COMPLETE, comp1, PapiReferenceResolver.empty());
      assertNotNull(res1);
      ...
      var res2 =
          PostActionResolver.resolve(
              pcm, ExecutionPolicy.ON_COMPLETE, comp2, PapiReferenceResolver.empty());
      assertNotNull(res2);
    ...
    void papiInConditionEvaluation() {
      var cond =
          ConditionCompiler.compile(
              "%vault_eco_balance% >= 500", ConditionCompileOptions.forPreset());
      ...
      var def =
          new ConditionalPostCommandDefinition(
              "cond_papi", cond, ExecutionPolicy.ON_COMPLETE, trueAction, falseAction);

      var snapshot = new PresetSnapshot(Map.of(), Map.of(), Map.of(), Map.of("cond_papi", def), 1L);
      var completion = createCompletion(List.of(), snapshot);
      var pcm =
          new PostCommandMeta("cond_papi", new int[] {}, 0, false, DispatchTarget.PLAYER, true);

      // balance = 1000 -> true
      var richResolver = PapiReferenceResolver.fromMap(Map.of("vault_eco_balance", "1000"));
      var res1 =
          PostActionResolver.resolve(pcm, ExecutionPolicy.ON_COMPLETE, completion, richResolver);
      assertNotNull(res1);
      ...
      var res2 =
          PostActionResolver.resolve(pcm, ExecutionPolicy.ON_COMPLETE, completion, poorResolver);
      assertNotNull(res2);
    ...
    void missingPapiFailsClosed() {
      var cond =
          ConditionCompiler.compile(
              "%missing_token% equals \"abc\"", ConditionCompileOptions.forPreset());
      var trueAction = TrustedPresetAction.of("say ok", ExecuteAs.CONSOLE, 0);
      var def =
          new ConditionalPostCommandDefinition(
              "cond_papi_miss", cond, ExecutionPolicy.ON_COMPLETE, trueAction, null);

      var snapshot =
          new PresetSnapshot(Map.of(), Map.of(), Map.of(), Map.of("cond_papi_miss", def), 1L);
      var completion = createCompletion(List.of(), snapshot);
      var pcm =
          new PostCommandMeta(
              "cond_papi_miss", new int[] {}, 0, false, DispatchTarget.PLAYER, true);
    ...
    void papiOverlimitFailsClosed() {
      var cond =
          ConditionCompiler.compile(
              "%large_token% equals \"abc\"", ConditionCompileOptions.forPreset());
      var trueAction = TrustedPresetAction.of("say ok", ExecuteAs.CONSOLE, 0);
      var def =
          new ConditionalPostCommandDefinition(
              "cond_papi_big", cond, ExecutionPolicy.ON_COMPLETE, trueAction, null);

      var snapshot =
          new PresetSnapshot(Map.of(), Map.of(), Map.of(), Map.of("cond_papi_big", def), 1L);
      var completion = createCompletion(List.of(), snapshot);
      var pcm =
          new PostCommandMeta("cond_papi_big", new int[] {}, 0, false, DispatchTarget.PLAYER, true);
      ...
      var ex =
          assertThrows(
              ...
              () ->
                  PostActionResolver.resolve(
                      pcm, ExecutionPolicy.ON_COMPLETE, completion, resolver));
      assertEquals(DispatchErrorKind.INVALID_REQUEST, ex.getError().kind());
    }
    ...
    void papiControlCharacterFailsClosed() {
      var cond =
          ConditionCompiler.compile(
              "%bad_token% equals \"abc\"", ConditionCompileOptions.forPreset());
      var trueAction = TrustedPresetAction.of("say ok", ExecuteAs.CONSOLE, 0);
      var def =
          new ConditionalPostCommandDefinition(
              "cond_papi_ctrl", cond, ExecutionPolicy.ON_COMPLETE, trueAction, null);

      var snapshot =
          new PresetSnapshot(Map.of(), Map.of(), Map.of(), Map.of("cond_papi_ctrl", def), 1L);
      var completion = createCompletion(List.of(), snapshot);
      var pcm =
          new PostCommandMeta(
              "cond_papi_ctrl", new int[] {}, 0, false, DispatchTarget.PLAYER, true);
    ...
    void flow11InjectionInAnswerIsData() {
      var cond =
          ConditionCompiler.compile(
              "{0} equals \"<!cmd> ; /op hacker\"", ConditionCompileOptions.forPreset());
      var trueAction = TrustedPresetAction.of("say match", ExecuteAs.CONSOLE, 0);
      var def =
          new ConditionalPostCommandDefinition(
              "cond_flow11", cond, ExecutionPolicy.ON_COMPLETE, trueAction, null);

      var snapshot =
          new PresetSnapshot(Map.of(), Map.of(), Map.of(), Map.of("cond_flow11", def), 1L);
      var completion = createCompletion(List.of("<!cmd> ; /op hacker"), snapshot);
      var pcm =
          new PostCommandMeta("cond_flow11", new int[] {}, 0, false, DispatchTarget.PLAYER, true);
