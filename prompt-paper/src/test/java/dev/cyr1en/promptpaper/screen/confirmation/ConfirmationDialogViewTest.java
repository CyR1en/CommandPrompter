...
class ConfirmationDialogViewTest extends MockBukkitTest {
    ...
    void setUpConfirmationDialog() {
        ...
        testLauncher = new ConfirmationDialogView.DialogLauncher() {
            @Override
    ...
    void dialogConfigConstructor() {
        var dialogConfig = DialogConfig.legacy(
    ...
    void synchronousLauncherFailureInvokesOnOpenFailure() {
        ...
        ConfirmationDialogView.DialogLauncher failingLauncher = (p, onConfirm, onDecline) -> {
            throw expectedError;
        };
    ...
    void coordinatorIntegrationWithFallbackChain() {
        var failureRef = new AtomicReference<Throwable>();
        var failingLauncher = new ConfirmationDialogView.DialogLauncher() {
            @Override
            public void show(Player p, Runnable onConfirm, Runnable onDecline) {
        ...
        var failingDialogView = new ConfirmationDialogView(
                plugin,
                player,
