...
class ConfirmationGuiConfigTest extends MockBukkitTest {
  ...
  void invalidSizeThrows() {
    assertThrows(
        IllegalArgumentException.class, () -> ConfirmationGuiConfig.builder().size(0).build());
    assertThrows(
        IllegalArgumentException.class, () -> ConfirmationGuiConfig.builder().size(25).build());
    assertThrows(
        IllegalArgumentException.class, () -> ConfirmationGuiConfig.builder().size(63).build());
  }
