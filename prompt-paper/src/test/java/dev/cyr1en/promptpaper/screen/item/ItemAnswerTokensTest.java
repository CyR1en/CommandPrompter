...
class ItemAnswerTokensTest extends MockBukkitTest {
    ...
    void testFromSelectionAllFormats() {
        ...
        // KEY
        assertEquals("minecraft:diamond_sword", ItemAnswerTokens.fromSelection(ItemOutputFormat.KEY, snapshot, item));

        // MATERIAL
        assertEquals("DIAMOND_SWORD", ItemAnswerTokens.fromSelection(ItemOutputFormat.MATERIAL, snapshot, item));
    ...
    void testFromSelectionNullChecks() {
        ...
        assertThrows(NullPointerException.class, () -> ItemAnswerTokens.fromSelection(null, snap, item));
        assertThrows(NullPointerException.class, () -> ItemAnswerTokens.fromSelection(ItemOutputFormat.KEY, null, item));
        assertThrows(NullPointerException.class, () -> ItemAnswerTokens.fromSelection(ItemOutputFormat.KEY, snap, null));
    }
    ...
    void testFromCatalogEntryValidFormats() {
        ...
        // KEY
        assertEquals("minecraft:golden_apple", ItemAnswerTokens.fromCatalogEntry(ItemOutputFormat.KEY, entry));

        // MATERIAL
        assertEquals("GOLDEN_APPLE", ItemAnswerTokens.fromCatalogEntry(ItemOutputFormat.MATERIAL, entry));
    ...
    void testFromCatalogEntrySlotThrows() {
        ...
        assertThrows(IllegalArgumentException.class, () -> ItemAnswerTokens.fromCatalogEntry(ItemOutputFormat.SLOT, entry));
    }
    ...
    void testFromCatalogEntryNullChecks() {
        ...
        assertThrows(NullPointerException.class, () -> ItemAnswerTokens.fromCatalogEntry(ItemOutputFormat.KEY, null));
    }

    @ParameterizedTest
    @EnumSource(ItemOutputFormat.class)
    @DisplayName("fromSelection throws IllegalArgumentException for empty snapshots or items across all formats")
    void testFromSelectionRejectsEmptyAcrossAllFormats(ItemOutputFormat format) {
        ...
        ItemSnapshot validSnap = ItemSnapshot.of(0, validItem, ItemFingerprintEncoder.encode(validItem));

        assertThrows(IllegalArgumentException.class, () -> ItemAnswerTokens.fromSelection(format, emptySnap, validItem));
        assertThrows(IllegalArgumentException.class, () -> ItemAnswerTokens.fromSelection(format, emptySnap, airItem));
        assertThrows(IllegalArgumentException.class, () -> ItemAnswerTokens.fromSelection(format, validSnap, airItem));
        assertThrows(IllegalArgumentException.class, () -> ItemAnswerTokens.fromSelection(format, validSnap, emptyItem));
    }
}
