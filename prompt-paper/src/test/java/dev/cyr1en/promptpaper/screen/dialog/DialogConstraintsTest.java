...
class DialogConstraintsTest {
  ...
  private final DialogConfig defaults =
      DialogConfig.legacy("Title", "Confirm", "Tooltip", "Cancel", "Tooltip");
  ...
  void numPerTagRangeOverridesConfigDefaultInitial() {
    ...
    assertEquals(
        12.0f, c.initial(), 0.0001f, "Initial must be per-tag midpoint, not config midpoint");
  }
