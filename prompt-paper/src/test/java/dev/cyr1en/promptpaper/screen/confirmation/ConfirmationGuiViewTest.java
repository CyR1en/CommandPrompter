...
class ConfirmationGuiViewTest extends MockBukkitTest {
    ...
    void setUpConfirmationGui() {
        ...
        var config = ConfirmationGuiConfig.createDefault(
    ...
    void allInventoryInteractionsCancelled() {
        ...
        var shiftClickTop = new InventoryClickEvent(
                invView, InventoryType.SlotType.CONTAINER, 0, ClickType.SHIFT_LEFT, InventoryAction.MOVE_TO_OTHER_INVENTORY);
        ...
        var clickBottom = new InventoryClickEvent(
                invView, InventoryType.SlotType.QUICKBAR, 27, ClickType.LEFT, InventoryAction.PICKUP_ALL);
        ...
        // 3. Number key swap
        var numberKey = new InventoryClickEvent(
                invView, InventoryType.SlotType.CONTAINER, 11, ClickType.NUMBER_KEY, InventoryAction.HOTBAR_SWAP);
        ...
        var offhandSwap = new InventoryClickEvent(
                invView, InventoryType.SlotType.CONTAINER, 11, ClickType.SWAP_OFFHAND, InventoryAction.HOTBAR_SWAP);
