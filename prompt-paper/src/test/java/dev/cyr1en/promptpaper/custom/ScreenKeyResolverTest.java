...
class ScreenKeyResolverTest {
    ...
    void setUp() {
        ...
        resolver = new ScreenKeyResolver(
                registry,
                Map.of("mapped_anvil", ScreenType.ANVIL, "mapped_dialog", ScreenType.DIALOG)
        );
    ...
    class BuiltInMappingsTests {
        ...
        void testStandardBuiltIns() {
            assertEquals(ScreenType.ANVIL, ((ScreenResolution.BuiltIn) resolver.resolve("a")).screenType());
            assertEquals(ScreenType.ANVIL, ((ScreenResolution.BuiltIn) resolver.resolve("anvil")).screenType());

            assertEquals(ScreenType.SIGN, ((ScreenResolution.BuiltIn) resolver.resolve("s")).screenType());
            assertEquals(ScreenType.SIGN, ((ScreenResolution.BuiltIn) resolver.resolve("sign")).screenType());

            assertEquals(ScreenType.PLAYER, ((ScreenResolution.BuiltIn) resolver.resolve("p")).screenType());
            assertEquals(ScreenType.PLAYER, ((ScreenResolution.BuiltIn) resolver.resolve("player")).screenType());

            assertEquals(ScreenType.DIALOG, ((ScreenResolution.BuiltIn) resolver.resolve("d")).screenType());
            assertEquals(ScreenType.DIALOG, ((ScreenResolution.BuiltIn) resolver.resolve("dialog")).screenType());

            assertEquals(ScreenType.CONFIRMATION, ((ScreenResolution.BuiltIn) resolver.resolve("c")).screenType());
            assertEquals(ScreenType.CONFIRMATION, ((ScreenResolution.BuiltIn) resolver.resolve("confirm")).screenType());
            assertEquals(ScreenType.CONFIRMATION, ((ScreenResolution.BuiltIn) resolver.resolve("confirmation")).screenType());

            assertEquals(ScreenType.ITEM, ((ScreenResolution.BuiltIn) resolver.resolve("i")).screenType());
            assertEquals(ScreenType.ITEM, ((ScreenResolution.BuiltIn) resolver.resolve("item")).screenType());
        }
    ...
    class CollisionDetectionTests {
        ...
        void testCollisionDetection() {
            ...
            Map<String, ScreenType> candidateConfig = Map.of(
                    "other_key", ScreenType.SIGN,
                    "my_active_screen", ScreenType.ANVIL
            );

            IllegalStateException ex = assertThrows(IllegalStateException.class, () ->
                    resolver.validateNoCollisions(candidateConfig));
        ...
        void testNoCollisions() {
            ...
            Map<String, ScreenType> nonCollidingConfig = Map.of(
