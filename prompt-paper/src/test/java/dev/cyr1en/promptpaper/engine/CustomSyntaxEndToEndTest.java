...
class CustomSyntaxEndToEndTest extends MockBukkitTest {
    ...
    void testCustomSyntaxExampleEndToEnd() {
        ...
        var compiledSimple = ActionTemplateCompiler.compile("say [[0]]", customSyntax, ActionTrustLevel.UNTRUSTED_INLINE);
        var bindings = ActionTemplateBindings.of(List.of("Alice"), player.getName(), PapiReferenceResolver.empty());
        ...
        var compiledUpper = ActionTemplateCompiler.compile("msg [[player|upper]] [[0|upper]]", customSyntax, ActionTrustLevel.UNTRUSTED_INLINE);
